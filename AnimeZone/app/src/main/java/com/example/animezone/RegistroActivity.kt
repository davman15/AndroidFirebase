        ...
        registrarse.setOnClickListener {
            ...
            auth.createUserWithEmailAndPassword(email, contrasena)
                ...
                .addOnSuccessListener {
                    ...
                    val foto="https://firebasestorage.googleapis.com/v0/b/animezone-82466.appspot.com/o/ImagenPerfilPorDefecto%2Fsinperfil.png?alt=media&token=79062551-4c24-45d7-9243-21030e6755b9"
                    //Creo el objeto que voy a enviar a la base de datos
                    val usuario: Usuario = Usuario(nombre, null, email, usuarioId, contrasena,foto)
