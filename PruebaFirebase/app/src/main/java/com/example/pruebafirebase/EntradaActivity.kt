...
class EntradaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        basedeDatos.collection("Publicaciones").addSnapshotListener{ value, error ->
            ...
            reciclerView.apply {
                ...
                layoutManager=LinearLayoutManager(this@EntradaActivity)
                //El recyclerView nos pide un adapter que es el q hemos hecho: minuto 40 y 1h por ahi
                adapter=PublicacionAdapter(this@EntradaActivity,publicaciones)
            }
        }
    ...
    //Esos metodos de abajo pertenecen a que yo pueda con el ToolBar de arriba cerrar Sesion mediante el menu creado
